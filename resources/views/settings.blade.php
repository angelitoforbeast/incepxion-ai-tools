            ...
            <div class="max-w-xl">
                ...
                @else
                    ...
                    <div class="mt-3 flex items-center gap-3 rounded-lg bg-slate-50 border border-slate-200 px-4 py-3">
                        ...
                        <p class="text-sm text-slate-600">Naka-sign in ka gamit ang <strong>Google</strong>, kaya walang password na kailangan. Ang seguridad ng login mo ay pinangangasiwaan ng Google.</p>
                    </div>
                @endif
            </div>
        </div>
